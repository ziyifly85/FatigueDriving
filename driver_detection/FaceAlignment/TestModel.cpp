...
double TestModel (vector<string> testDataName){
    vector<cv::Mat_<uchar> > test_images;
    vector<BoundingBox> test_bounding_boxs;
    vector<cv::Mat_<double> >test_ground_truth_shapes;
...
//    LoadCofwTestData(test_images, test_ground_truth_shapes, test_bounding_boxs);
    ...
    vector<cv::Mat_<double> > current_shapes = regressor.Predict(test_images,test_bounding_boxs,
